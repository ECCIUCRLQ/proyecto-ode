...
EXPORTED const char _module_capabilities_[] =
	...
	"BUILDDATE:" "1657819309" ";"
	"MOD:" "sample-pci-device" ";"
	"CLS:sample_pci_device" ";"
	"HOSTTYPE:" "linux64" ";"
	"THREADSAFE;"
	EXTRA ";";
EXPORTED const char _module_date[] = "Thu Jul 14 18:21:49 2022";
extern void _initialize_sample_pci_device_dml(void);
...
_simics_module_init(void)
{
	...
	_initialize_sample_pci_device_dml();
	init_local();
}
